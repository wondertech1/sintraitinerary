...
export const quintaDaRegaleira: PalaceGuideData = {
  ...
  quickFacts: {
    ...
    gettingThere: "10-minute walk from Sintra town center (flat, easy)",
    openingHours: "10am–7:30pm (Apr–Sep), 10am–6:30pm (Oct–Mar). Last entry 1 hour before close.",
  ...
  sections: [
    {
      id: "initiation-well",
      title: "The Initiation Well (Poço Iniciático)",
      content:
    ...
    {
      id: "garden-route",
      title: "The Best Route Through the Gardens",
      content:
    ...
    options: [
      {
        ...
        price: "€20",
        includes: "Palace + gardens + wells + tunnels. Everything.",
        recommended: true,
        note: "One ticket covers the entire estate. No grounds-only / interior-only split like Pena.",
      },
      {
        name: "Guided Tour",
        price: "€17–22",
  ...
  photoSpots: [
    {
      name: "Inside the Initiation Well (looking up)",
      description: "Stand at the bottom and shoot upward through the spiral. The circular opening to the sky is the iconic shot.",
      bestTime: "Midday (sun directly overhead, illuminating the well)",
      crowdTip: "Wait for a gap in the crowd above. Early morning or late afternoon gives you the best chance of an empty well. The shot only takes 30 seconds — patience pays off.",
    },
    {
      name: "The Stepping Stones",
      description: "The flat stones crossing the underground lake pool. Shoot from the grotto entrance for the full atmospheric effect.",
      bestTime: "Any time (underground, lighting is consistent)",
      crowdTip: "Visit on a weekday or early morning. Weekend afternoons are the worst.",
    },
    {
      name: "The Palace Facade",
      description: "The full Manueline facade with the octagonal tower. Shoot from the lower garden path for the best angle.",
      bestTime: "Morning (east-facing facade catches golden light)",
      crowdTip: "The palace exterior is rarely crowded — most people rush past it to the gardens.",
    },
    {
      name: "The Waterfall Grotto Exit",
      description: "Where the tunnel emerges into the cascading pools. Lush, atmospheric, and Instagram-ready.",
      bestTime: "Afternoon (dappled light through the trees)",
      crowdTip: "The tunnel exit is a bottleneck — step aside and wait for it to clear.",
    },
  ],
  ...
  faqs: [
    {
      question: "Is Quinta da Regaleira worth visiting?",
      answer:
    ...
    {
      question: "How long do you need at Quinta da Regaleira?",
      answer:
    ...
    {
      question: "Can I visit Regaleira with a stroller?",
      answer:
    ...
    {
      question: "Is Quinta da Regaleira part of Parques de Sintra?",
      answer:
    ...
    {
      question: "What's the difference between the two wells?",
      answer:
    ...
    {
      question: "Is the guided tour worth it?",
      answer:
