...
export const nationalPalace: PalaceGuideData = {
  slug: "national-palace-guide",
  name: "National Palace of Sintra",
  subtitle: "The twin-chimney palace you can visit without climbing a single hill",
  ...
  verdict: {
    rating: "conditional",
    summary:
      "The National Palace is Sintra's easiest visit — right in the town center, no hills, no buses, no 40-minute hike. The medieval kitchens with their iconic twin chimneys, the Magpie Room ceiling, and the extensive Moorish tilework are genuine highlights. But compared to Regaleira's drama or Pena's spectacle, it's more historically interesting than visually thrilling. Visit if you have time; skip if you're short on hours. It's the most 'skippable' of the five major palaces, but still a solid hour of culture.",
    bestFor: "History lovers, those with mobility concerns, rainy day backup, families needing an easy option",
    skipIf: "You only have 1 day and need to choose between this and Regaleira or Moorish Castle. Those win.",
  },
  ...
  quickFacts: {
    ...
    cost: "€13",
    crowdLevel: 2,
    bestTime: "Afternoon (day-trippers head uphill to Pena in the morning)",
    gettingThere: "In the town center — 5-minute walk from the train station. No transport needed.",
    openingHours: "9:30am–6:30pm (last entry 6pm)",
  ...
  sections: [
    ...
    {
      id: "audio-guide",
      title: "The Audio Guide (Actually Good)",
      content:
    ...
    {
      id: "history-layers",
      title: "500 Years of Portuguese Royalty",
      content:
  ...
  tickets: {
    intro: "Managed by Parques de Sintra. Straightforward single ticket — no grounds/interior split.",
    options: [
      {
        name: "General Admission",
        price: "€13",
        includes: "Full palace interior + audio guide included.",
        recommended: true,
        note: "The audio guide alone makes this reasonable value. No extra fees.",
      },
    ],
    buyOnline: "Buy at parquesdesintra.pt. Rarely sells out — walk-up is almost always fine.",
    comboDeals: "Available in multi-palace combos, but the individual €13 ticket is fine for most visitors. Only combo-up if visiting 4+ sites.",
  },

  photoSpots: [
    {
      name: "Twin Chimneys from the Town Square",
      description: "The most recognizable Sintra silhouette. Best shot from the square below with café tables in the foreground.",
      bestTime: "Late afternoon (warm light on the white facade)",
      crowdTip: "The exterior is public space — always accessible. Morning crowds block the view less.",
    },
    {
      name: "Inside the Kitchen (Chimneys from Below)",
      description: "Stand inside the kitchen and look straight up through the 33-meter chimneys. Dramatic geometry.",
      bestTime: "Any time (indoor)",
      crowdTip: "Wait for a gap between tour groups for a clear shot.",
    },
    {
      name: "The Arab Room",
      description: "The geometric tilework and central fountain. The most photogenic room in the palace.",
      bestTime: "Any time (indoor, consistent lighting)",
      crowdTip: "Small room — wait 30 seconds for it to empty between groups.",
    },
  ],
  ...
  faqs: [
    {
      question: "Is the National Palace worth visiting?",
      answer:
    ...
    {
      question: "What's the best time to visit the National Palace?",
      answer:
